            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                   <ul id="sidebarnav">
                        ...
                        <li> <a href="challan.php" aria-expanded="false"><i class="fa fa-thumb-tack f-s-20 color-warning"></i><span class="hide-menu">Challan</span></a>
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="container-fluid">
                ...
                <div class="form-actions">
                     ...
                     onclick="window.open('create_challan.php', '_blank')" >Create Challan</button>
                </div>
                <br>
                <div class="form-actions">
                     <button class="btn btn-info btn-lg btn-block" 
                     onclick="window.open('view_challan.php', '_blank')" >View Challan</button>
                </div>
                <!-- End PAge Content -->
            </div>
            <!-- End Container fluid  -->
